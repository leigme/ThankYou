...
import com.yhcloud.thankyou.module.index.view.MineActivityView;
...
public class MineManage {
    ...
    private MineActivityView mIMineView;
    ...
    public MineManage(MineActivityView mineView, LogicService service) {
