...
public class HomeworkLogic {
    ...
    public void getTeacherHomeworkList(String userId, String page, final ResponseCallBack<String> responseCallBack) {
    ...
    public void getStudentHomeworkList(String userId, String page, final ResponseCallBack<String> responseCallBack) {
    ...
    public void getStudentHomeworkInfo(String userId, String workBookId, final ResponseCallBack<String> responseCallBack) {
    ...
    public void sendObjectiveHomeworkToService(String userId, String jsonData, final ResponseCallBack<String> responseCallBack) {
        OkHttpUtils.post()
    ...
    public void sendImagesToService(String userId, String workId, String questionId, String content,
                                    ...
                                    List<String> images, final ResponseCallBack<String> responseCallBack) {
    ...
    public void updateStudentHomework(String workId, final ResponseCallBack<String> responseCallBack) {
        OkHttpUtils.post()
    ...
    public void getTeacherHomeworkInfo(String homeworkId, final ResponseCallBack<String> responseCallBack) {
        OkHttpUtils.post()
