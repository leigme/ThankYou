package com.yhcloud.thankyou.utils.myview.pickerview.lib;
...
//    private int drawOutContentStart = 0;//非中间文字开始绘制位置
    private int drawCenterContentStart = 100;//中间选中文字开始绘制位置
    private int drawOutContentStart = 100;//非中间文字开始绘制位置
